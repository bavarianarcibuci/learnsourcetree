...
legend([smandril,lena,chrominance_sail,sail,sail_sub_cif,sail_sub_qcif, lena_predictive_still],'smandril-al', 'lena-al','sail-chrominance','sail-al','sail-sub-CIF','sail-sub-QCIF', 'lena-predictive-still', 'Location', 'Best' );
