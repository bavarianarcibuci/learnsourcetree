...
for j = 1 : 10
    ...
    image_fore0020 = double( imread( 'data/images/silent20_40_RGB/silent0020.bmp' ) );
    ...
    for i = 1:20
        image = double(imread(strcat('data/images/silent20_40_RGB/silent00', num2str(20+i), '.bmp' )));
