...
legend([smandril,lena,chrominance_sail,sail,sail_sub_cif,sail_sub_qcif],'smandril-al', 'lena-al','sail-chrominance','sail-al','sail-sub-CIF','sail-sub-QCIF', 'Location', 'Best' );
