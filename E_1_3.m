...
image_prefiltered = prefilterlowpass2d( image, w2 );     %prefiltered image
...
image_postprefiltered = prefilterlowpass2d( image_upsample * 4, w2 );     %post filtered image

MSE_wpf = calcMSE( image, image_postprefiltered, dimension, height, width );
...
image_postfiltered_wopf = prefilterlowpass2d( image_upsample_wopf * 4, w2 );   %post filtered image
...
subplot( 1, 3, 2 )
imshow( image_postprefiltered / 256 );
